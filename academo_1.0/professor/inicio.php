...
// --- LÓGICA PARA O RESUMO (da versão antiga) ---
$professor_id = (int)$_SESSION['usuario_id'];
$stmt = $conn->prepare("
    SELECT 
        COUNT(DISTINCT c.id_classes) as total_turmas,
        COUNT(DISTINCT e.id_enrollments) as total_alunos
    FROM classes c
...
<p class="descricao">
  Utilize o menu lateral para gerenciar suas turmas, lançar notas, registrar a frequência dos alunos e administrar as tarefas.
</p>
...
<div class="box">
    ...
    <div class="summary-grid">
        <div class="summary-item">
            <h3>Turmas Ativas</h3>
            <p><?= $summary['total_turmas'] ?? 0 ?></p>
        </div>
        <div class="summary-item">
            <h3>Total de Alunos</h3>
            <p><?= $summary['total_alunos'] ?? 0 ?></p>
        </div>
    </div>
</div>
<script>
