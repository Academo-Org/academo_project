...
function getSystemInstruction(role, page, name, screenData) {
    ...
    // 3. Montagem das Regras
    let rules = `
    INSTRUÇÕES MESTRAS:
    1. ${persona}
    2. O usuário está na URL: ${page}.
    3. ${visualContext}
    4. Se o usuário perguntar "qual minha nota?" ou "o que tenho pra fazer?", LEIA os dados acima (em VISÃO DA TELA) e responda.
    5. Se a pergunta for sobre navegação, use o Manual Visual (Barra Verde, Ícones, etc).
    6. NUNCA invente dados que não estão na tela.
