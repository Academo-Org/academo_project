...
<head>
  ...
  <style>
    /* Cole aqui o mesmo CSS que usamos no professor_dashboard.php para manter a consistência */
  ...
  <div class="container">
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="?page=cadastrar_usuario" class="<?= ($page === 'cadastrar_usuario') ? 'active' : '' ?>">➕ Cadastrar Usuário</a>
            <a href="?page=gerenciar_usuarios" class="<?= ($page === 'gerenciar_usuarios' || $page === 'editar_usuario') ? 'active' : '' ?>">👥 Gerenciar Usuários</a>
            <a href="?page=gerenciar_turmas" class="<?= ($page === 'gerenciar_turmas' || $page === 'editar_turma') ? 'active' : '' ?>">🏫 Gerenciar Turmas</a>
            <a href="?page=gerenciar_matriculas" class="<?= ($page === 'gerenciar_matriculas') ? 'active' : '' ?>">🎓 Gerenciar Matrículas</a>
        </nav>
    ...
    <main class="main-content">
        <?php
        // ### CORREÇÃO AQUI! ###
        // Adicionamos 'editar_usuario' e 'editar_turma' à lista de páginas permitidas.
