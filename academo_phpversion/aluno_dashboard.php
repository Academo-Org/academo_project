  ...
  <div class="container">
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="?page=materias" class="<?= ($page === 'materias') ? 'active' : '' ?>">📚 Minhas Matérias</a>
            <a href="?page=notas" class="<?= ($page === 'notas') ? 'active' : '' ?>">📊 Minhas Notas</a>
            <a href="?page=presenca" class="<?= ($page === 'presenca') ? 'active' : '' ?>">📋 Minhas Presenças</a>
            <a href="?page=tarefas" class="<?= ($page === 'tarefas') ? 'active' : '' ?>">📝 Minhas Tarefas</a>
        </nav>
    ...
    <main class="main-content">
        <?php
        // CORREÇÃO: 'tarefas' adicionado à lista
